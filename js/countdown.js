...
(function() {
  ...
  function countDown(config) {
    var defaultOptions = {
      ...
      render: function(outstring) {
        $('.my-time').html(outstring);
      },
      end: function() {
        $('.my-time').html('00:00:00:00');
      },
  ...
  countDown.prototype = {
    ...
    init: function() {
      ...
      var ajaxPost = new timer(50*1000);
      ajaxPost.add(function(){
        snapshotExam();
      })
  ...
  new countDown({
    endTime: new Date(examData.info.snapshotExpires.replace(/-/g,"/"))
  });
